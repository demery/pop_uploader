...
RSpec.configure do |config|
  config.include PopUploader::GlobalHelpers

  # suppress but keep STDOUT and STDERR
...
=end
  ...
  config.fixtures_path = File.join(File.dirname(__FILE__), 'fixtures')
